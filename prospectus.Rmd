...
I have never analysed spatial data. I'm unfamiliar with the specialized data classes necessary for this analysis (e.g. `sp::SpatialPointsDataFrame`) and am new to virtually every aspect of the packages designed to handle these data (e.g. `adehabitatHR`).
