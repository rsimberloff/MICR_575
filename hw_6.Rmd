...
#### Description
This is a box plot (`geom_boxplot`) overlaid with a scatter plot (`geom_point`).  

Each point represents testosterone level in an individual bird.  
* *x*-axis is mapped to the bird species (4 levels) and is further subsetted by sex (categorical, un-ordered)  
* *y*-axis is mapped to the level of testosterone in circulation (continuous, log-transformed)  
